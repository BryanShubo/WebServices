...
public class ObjectFactory {
    ...
    private final static QName _GetOrdersRequest_QNAME = new QName("http://soap.server/", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://soap.server/", "getOrdersResponse");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://soap.server/", "createOrdersResponse");
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://soap.server/", "createOrdersRequest");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.server/", name = "getOrdersRequest")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.server/", name = "getOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.server/", name = "createOrdersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.server/", name = "createOrdersRequest")
