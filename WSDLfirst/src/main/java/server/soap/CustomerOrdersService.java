 ...
 * 2015-07-26T16:56:26.722-04:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/C:/Users/Shubo/Desktop/GitHub/WebServices/WebServices/WSDLfirst/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
                  targetNamespace = "http://soap.server/") 
public class CustomerOrdersService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://soap.server/", "CustomerOrdersService");
    public final static QName CustomerOrdersPort = new QName("http://soap.server/", "CustomerOrdersPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Shubo/Desktop/GitHub/WebServices/WebServices/WSDLfirst/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Shubo/Desktop/GitHub/WebServices/WebServices/WSDLfirst/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
